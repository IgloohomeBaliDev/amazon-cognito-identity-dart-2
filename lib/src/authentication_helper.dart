...
class AuthenticationHelper {
  ...
  List<int> getPasswordAuthenticationKey(String username, String password,
    BigInt serverBValue, BigInt salt) {
  ...
  String toUnsignedHex(String input) {
    ...
    if (negative) {
      ...
      String updatedLeadingDigit = (int.parse(toReplace) | 0x8).toRadixString(
        16);
